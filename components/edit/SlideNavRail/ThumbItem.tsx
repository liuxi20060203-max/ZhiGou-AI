  ...
  return (
    ...
    >
      <div
        ...
        // tile adopts the product primary tint + ring when active. Differences from
            ...
            {renaming ? (
              <input
                ...
                className={cn(
                  ...
                  'ring-1 ring-primary/60 focus:ring-primary',
                  'text-zinc-800 dark:bg-zinc-900 dark:text-zinc-100 dark:ring-primary/70',
                )}
              />
            ) : (
              <span
 ...
 * video thumbnail card, whole tile rounded with a primary-colour background +
