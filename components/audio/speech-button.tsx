      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-primary text-primary-foreground shadow-[0_0_14px_color-mix(in_srgb,var(--primary)_42%,transparent)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-primary/45"
              style={{
