    ...
    <>
      ...
      >
        {/* Native (OS) fullscreen takes over the top-right slot: OpenMAIC's
            ...
            branded, borderless-ish treatment mirrors the native control
        ...
        {nativeFullscreen ? (
          <button
            ...
            className="absolute right-4 top-4 z-40 flex h-8 w-8 items-center justify-center rounded-md border border-primary/35 bg-primary/20 text-primary shadow-sm backdrop-blur transition-colors hover:bg-primary/30"
