...
export function UserProfileCard() {
  ...
  if (!hydrated) {
    return (
      <Card className="!gap-0 border-border/70 bg-card/95 p-5 shadow-lg backdrop-blur-xl">
  ...
  return (
    <Card className="!gap-0 border-border/70 bg-card/95 p-5 shadow-lg backdrop-blur-xl">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 overflow-hidden rounded-full bg-gray-50 ring-2 ring-primary/25 transition-all group-hover/avatar:ring-primary/55 dark:bg-gray-800">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="h-7 min-w-0 flex-1 border-b-2 border-primary bg-transparent text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="flex size-6 shrink-0 items-center justify-center rounded-md text-primary transition-colors hover:bg-primary/10"
              >
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'border-primary/35 bg-primary/10 ring-2 ring-primary ring-offset-1 ring-offset-white dark:ring-offset-slate-900'
