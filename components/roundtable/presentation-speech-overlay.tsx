  ...
  return (
    ...
    >
      ...
      {bubble.role !== 'user' &&
        ...
        buttonState !== 'none' &&
        (() => {
          const barsColor = bubble.role === 'agent' ? 'var(--accent)' : 'var(--primary)';
          ...
          if (buttonState === 'play') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/20 transition-all duration-300 cursor-pointer"
              >
                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-primary ml-0.5" />
              </div>
            );
          }
          ...
          if (buttonState === 'restart') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/20 transition-all duration-300 cursor-pointer"
              >
                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-primary" />
              </div>
            );
          }
