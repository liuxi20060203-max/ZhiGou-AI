...
export function Roundtable({
  ...
  const referencePill = elementReferencePill ? (
    <div
      ...
      className="pointer-events-auto flex max-w-[min(520px,calc(100vw-3rem))] items-center gap-2 rounded-full border border-primary/25 bg-white/95 px-3 py-1.5 text-xs shadow-lg backdrop-blur dark:border-primary/40 dark:bg-gray-900/95"
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-primary hover:bg-primary/90 shadow-[0_4px_16px_rgba(23,107,135,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-primary/70 to-accent" />
                  </div>
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-primary to-accent shadow-[0_4px_20px_rgba(23,107,135,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      ...
                      <div className="flex items-center gap-[3px]">
                        {[0, 1, 2].map((i) => (
                          <motion.div
                            ...
                            className="w-[3px] h-[3px] rounded-full bg-primary/70"
                          />
                        ))}
                      </div>
                    </div>
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-primary shadow-[0_0_6px_rgba(23,107,135,0.3)]'
    ...
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        >
          ...
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-primary/10 dark:from-primary/10 to-transparent pointer-events-none" />
                ...
                <HoverCardTrigger asChild>
                  <div className="flex flex-col items-center gap-1">
                    ...
                    >
                      ...
                      <div className="w-10 h-10 rounded-full bg-card overflow-hidden relative z-10 shadow-sm border border-border/60">
                        <img
                          src={teacherAvatar}
                          alt={teacherName}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <span
                              ...
                              style={{
                                backgroundColor: teacherConfig?.color || 'var(--primary)',
                              }}
                            >
              ...
              {isInputOpen && (
                ...
                >
                  <div
                    ...
                    className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-card/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-primary/25 dark:border-primary/40 flex items-end gap-2 ring-1 ring-primary/10 dark:ring-primary/20"
                  >
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-primary hover:bg-primary/90 shadow-primary/20 dark:shadow-primary/30',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-card/80 backdrop-blur-md rounded-xl border border-primary/20 dark:border-primary/30 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-primary to-accent dark:from-primary/80 dark:to-accent" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-primary uppercase bg-card/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-primary/20 dark:border-primary/30 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-primary to-accent shadow-[0_4px_20px_rgba(23,107,135,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                    ...
                    <div className="absolute inset-0 rounded-full border border-accent opacity-20 animate-[ping_3s_ease-in-out_infinite_0.5s] z-10" />
                    <div className="absolute inset-0 bg-primary blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence>
              {thinkingState?.stage === 'director' && !currentSpeech && !userMessage && (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  exit={{ opacity: 0, scale: 0.9 }}
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex items-center gap-2 px-4 py-2 bg-card/90 backdrop-blur-md rounded-full shadow-sm border border-border/70"
                >
                  <div className="flex gap-1">
                    <motion.div
                      animate={{ opacity: [0.3, 1, 0.3] }}
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-primary to-accent dark:from-primary/80 dark:to-accent shadow-primary/30 dark:shadow-primary/20 hover:shadow-primary/40 dark:hover:shadow-primary/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor = bubbleRole === 'agent' ? 'bg-accent' : 'bg-primary';
                          ...
                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-primary/10 dark:hover:bg-primary/20 group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/20 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-primary group-hover/bubble:text-primary ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-primary/10 dark:hover:bg-primary/20 group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/20 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-primary group-hover/bubble:text-primary" />
                              </div>
                            );
                          }
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ...
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary hover:border-primary/25',
                    )}
                  >
                    {asrEnabled ? (
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-primary shadow-[0_0_8px_rgba(23,107,135,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-primary/40',
                  )}
                />
